    ...
    methods
        ...
        function r = getRecommendedSliceThickness(obj,triangleArray, currentHeight, thicknessIndex, thicknessArray)
            ...
            for count = thicknessIndex:height(thicknessArray)
                ...
                for j = 1 : height(intersectedTri)
                    ...
                    rec = HelperMethods.GetRecommendedThickness(currentTriangle.angle);
        ...
        function r = SliceModel(obj, model, increments)
            ...
            while (currentHeight < zMax)
                ...
                currentSliceThickness = obj.getRecommendedSliceThickness(triangleArray, currentHeight, thicknessIndex, thicknessArray);
